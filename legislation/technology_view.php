        ...
        <div class="container">
            ...
            <div class="lnb-list">
                <ul>
                    ...
                    <li class="active"><a href="/legislation/technology_list.php">KOBSA 기술 ∙ 동향</a></li>
                    <li><a href="/legislation/pathogen_list.php">병원체 / 등급시설</a></li>
                </ul>
            </div>
            
            <section class="technology-view">
                    ...
                    <article class="board-view">
						...
						<div class="btn-area">
							<p>
								...
								<a href="/legislation/technology_list.php" class="btn btn-sm btn-sm-bl" role="button">목록</a>
							</p>
						</div>
                    </article>
                </div>
