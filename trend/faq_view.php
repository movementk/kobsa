...
<body class="sub trend">
    ...
    <!-- page-header -->
    <?php require_once($_SERVER['DOCUMENT_ROOT'].'/trend/_pageheader.php'); ?>
        ...
        <div class="container">
            ...
            <div class="lnb-list">
                <ul>
                    ...
                    <li><a href="/trend/bulletin_list.php">관련 기관</a></li>
                    <li class="active"><a href="/trend/faq_list.php">FAQ</a></li>
                </ul>
            </div>
            ...
            <section class="notification-view">
                ...
                <div class="section-content">
                    ...
                    <div class="btn-area">
                        <p>
                            <a href="/trend/faq_list.php" class="btn btn-md btn-blue" role="button">목록</a>
                        </p>
                    </div>
                </div>
            </section>
